...
export const createProductImageSchema = z.object({
  imageUrl: z.string().url("Invalid image URL").max(500, "URL too long"),
...
export const getProductsQuerySchema = z.object({
  ...
  sortBy: z
    .enum(["name", "price", "createdAt", "viewCount"]) // match TS and DB column property names
    .default("createdAt"),
...
>;
export type UpdateProductImageRequest = z.infer<
